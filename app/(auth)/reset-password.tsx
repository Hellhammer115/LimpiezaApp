...
const schema = z
  .object({
    // Matches the project's Email OTP Length setting (Auth → Providers →
    // Email). If that setting is ever changed, update this regex and the
    // maxLength below to match, or the code can't be entered.
    code: z
      .string()
      .trim()
